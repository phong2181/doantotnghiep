...
<nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">Phong Nguyễn</strong>
                             </span> <span class="text-muted text-xs block">Quảng Trị Viên <b class="caret"></b></span> </span> </a>
                ...
                <li class="active">
                    <a href="index.html"><i class="fa fa-th-large"></i> <span class="nav-label">Trang tổng quan</span> <span class="fa arrow" style="display: none;"></span></a>
                </li>
                <li>
                    <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Thống kê</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="graph_flot.html">Số Lượng Thuê</a></li>
                        <li><a href="graph_morris.html">Doanh Thu</a></li>
                        <li><a href="graph_chartist.html">Chi Phí Bảo Dưỡng</a></li>
                        <li><a href="c3.html">Số Đánh Giá</a></li>
                        <li><a href="graph_peity.html">Lượng Try Cập</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li><a href="mail_detail.html">Phản hồi khách hàng</a></li>
                        <li><a href="mail_compose.html">Nội Bộ Công Ty</a></li>
                    </ul>
                </li>
                <li>
